...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::Lib_obj::setPackage(HX_CSTRING("Company Name"),HX_CSTRING("Submarine"),HX_CSTRING("com.example.submarine"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(32)
		::openfl::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::openfl::Lib_obj::HARDWARE) | int(::openfl::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Submarine"),null(),null());
	}
return null();
}
