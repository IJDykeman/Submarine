...
::UIBalastTankControl_obj::__register();
::UIActionType_obj::__register();
::UI_obj::__register();
::Type_obj::__register();
::ThrottleControl_obj::__register();
::UILever_obj::__register();
::UIElement_obj::__register();
::Submarine_obj::__register();
::StringTools_obj::__register();
::StringBuf_obj::__register();
::ShipEnd_obj::__register();
::SetEnginePowerUIAction_obj::__register();
::SetBalastTankLevelUIAction_obj::__register();
::Sailor_obj::__register();
::Reflect_obj::__register();
::Ocean_obj::__register();
::NoUIAction_obj::__register();
::UIAction_obj::__register();
::IMap_obj::__register();
::List_obj::__register();
::Lambda_obj::__register();
::Helpers_obj::__register();
::Flotsam_obj::__register();
::UnderwaterObject_obj::__register();
...
::IMap_obj::__boot();
::UIAction_obj::__boot();
::NoUIAction_obj::__boot();
::Ocean_obj::__boot();
::Reflect_obj::__boot();
::Sailor_obj::__boot();
::SetBalastTankLevelUIAction_obj::__boot();
::SetEnginePowerUIAction_obj::__boot();
::ShipEnd_obj::__boot();
::StringBuf_obj::__boot();
::StringTools_obj::__boot();
::Submarine_obj::__boot();
::UIElement_obj::__boot();
::UILever_obj::__boot();
::ThrottleControl_obj::__boot();
::Type_obj::__boot();
::UI_obj::__boot();
::UIActionType_obj::__boot();
::UIBalastTankControl_obj::__boot();
::Vector_obj::__boot();
::World_obj::__boot();
