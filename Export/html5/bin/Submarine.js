...
Actor.__super__ = openfl.display.Sprite;
Actor.prototype = $extend(openfl.display.Sprite.prototype,{
	update: function(seconds) {
		this.set_x(this.location.x * Constants.pixelsPerMeter);
		this.set_y(this.location.y * Constants.pixelsPerMeter);
	}
	,getMass: function() {
		return this.mass;
	}
	,setMass: function(nMass) {
		this.mass = nMass;
	}
	,__class__: Actor
});
...
var UnderwaterObject = function() {
	Actor.call(this);
};
$hxClasses["UnderwaterObject"] = UnderwaterObject;
UnderwaterObject.__name__ = ["UnderwaterObject"];
UnderwaterObject.__super__ = Actor;
UnderwaterObject.prototype = $extend(Actor.prototype,{
	update: function(seconds) {
		Actor.prototype.update.call(this,seconds);
		var drag = this.getAllForces();
		this.velocity.x += drag.x / this.getMass();
		this.velocity.y += drag.y / this.getMass();
	}
	,getDrag: function() {
	...
	,getAllForces: function() {
		...
		var bouyancyAndG = this.getBouyancyAndGravityForce();
		return new Vector(drag.x + bouyancyAndG.x,drag.y + bouyancyAndG.y);
	}
	,__class__: UnderwaterObject
});
var Flotsam = function(nX,nY) {
	UnderwaterObject.call(this);
	this.bitmap = new openfl.display.Bitmap(openfl.Assets.getBitmapData("assets/soccerBall.png"));
	this.bitmap.set_width(20);
	this.bitmap.set_height(20);
	this.addChild(this.bitmap);
	this.set_x(nX);
	this.set_y(nY);
};
$hxClasses["Flotsam"] = Flotsam;
Flotsam.__name__ = ["Flotsam"];
Flotsam.__super__ = UnderwaterObject;
...
$hxClasses["UIAction"] = UIAction;
UIAction.__name__ = ["UIAction"];
UIAction.prototype = {
	__class__: UIAction
};
var NoUIAction = function() {
	this.type = UIActionType.UIActionNone;
};
$hxClasses["NoUIAction"] = NoUIAction;
NoUIAction.__name__ = ["NoUIAction"];
NoUIAction.__super__ = UIAction;
NoUIAction.prototype = $extend(UIAction.prototype,{
...
Ocean.__name__ = ["Ocean"];
Ocean.__super__ = openfl.display.Sprite;
Ocean.prototype = $extend(openfl.display.Sprite.prototype,{
	__class__: Ocean
});
...
$hxClasses["SetEnginePowerUIAction"] = SetEnginePowerUIAction;
SetEnginePowerUIAction.__name__ = ["SetEnginePowerUIAction"];
SetEnginePowerUIAction.__super__ = UIAction;
SetEnginePowerUIAction.prototype = $extend(UIAction.prototype,{
...
Submarine.__super__ = UnderwaterObject;
...
UIElement.__super__ = openfl.display.Sprite;
UIElement.prototype = $extend(openfl.display.Sprite.prototype,{
...
var World = function() {
	...
	this.boot = new Submarine();
	this.addChild(this.boot);
	var _g = 0;
	while(_g < 100) {
		var i = _g++;
		this.addChild(new Flotsam(150 * i,600));
	}
	haxe.Log.trace("world cons",{ fileName : "World.hx", lineNumber : 21, className : "World", methodName : "new"});
};
$hxClasses["World"] = World;
World.__name__ = ["World"];
World.__super__ = openfl.display.Sprite;
World.prototype = $extend(openfl.display.Sprite.prototype,{
	update: function() {
